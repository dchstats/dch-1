...
app.controller('ctrl', function ($scope) {
	...
	$scope.refresh = function () {
		...
		$scope.shovels_total.east_coal_100_trips = 0;
		$scope.shovels_total.east_coal_120_trips = 0;
		$scope.shovels_total.east_ob_100_trips = 0;
		$scope.shovels_total.east_ob_120_trips = 0;

		$scope.shovels_total.west_coal_100_trips = 0;
		$scope.shovels_total.west_coal_85_trips = 0;
		$scope.shovels_total.west_ob_100_trips = 0;
		$scope.shovels_total.west_ob_85_trips = 0;
