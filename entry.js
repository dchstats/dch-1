...
app.controller('ctrl', function ($scope, $http) {
	...
	function shiftDecode(d) {
		var a = new Date(2019, 3, 1, 6, 0, 0, 0);
		var b = a.getTime();
		var e = b + (d) * 8 * 3600 * 1000;
		var f = new Date(e);
		var g = f.getDay() + '-' + f.getMonth()+ '-' + f.getFullYear();
		$scope.status = g;

		var g = d % 3;
		var h = $scope.shifts[g];
		console.log(h);
	}
	function appGlobals() {
		$scope.date = new Date();
		$scope.shovel_names = ['P&H_06', 'P&H_07', 'P&H_09', 'P&H_10', 'P&H_11', 'P&H_12', 'P&H_13', 'P&H_14', 'P&H_15',
